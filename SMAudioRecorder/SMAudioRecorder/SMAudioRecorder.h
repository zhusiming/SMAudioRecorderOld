 ...
 */
typedef void(^StopAudioRecorder)(BOOL complete ,NSString *amrfilePath);

@interface SMAudioRecorder : NSObject<AVAudioRecorderDelegate>
{
    
    AVAudioRecorder *_recorder;         // 音频录制对象
